...
| **Version** | v0.9.4 + six differentiation bets, three measured (2026-05-08). v0.9 chat is the ghost-small bench winner (CTIBench full 28.9%, CTF eval 59.2%, SecQA 39.3%, fact recall 1/100 on v2). The 81M ghost-small line saturates as a register-matching parrot. **v0.9.4 adds six concrete bets to be different**, strategic frame at [`docs/differentiation.md`](docs/differentiation.md): (1) tool-grounded SFT, (2) daily LoRA over fresh threat-intel, (3) custom 32K BPE (settled at +4% on cyber / -2.5% on general; ablation in [`docs/bpe_corpus_ablation.md`](docs/bpe_corpus_ablation.md)), (4) RoPE NTK 16K context, (5) MoE for ghost-1B+ (100-step training smoke PASS, [`docs/moe_training_smoke.md`](docs/moe_training_smoke.md); presets `ghost-1b` 2.1B/1.2B-active and `ghost-3b` 6.0B/3.3B-active), (6) format-aware pretrain for STIX/YARA/Sigma/MISP (v0.9 baseline 0/8 = 0%; lift target locked, [`docs/format_baseline_v09.md`](docs/format_baseline_v09.md)). The v1.0 corpus has been built (516,736 train / 27,049 val / ~363M tokens / six domains). Ghost-base launcher (`scripts/train_ghost_base.py`, ~360M params) shipped, gated on rented GPU. |
